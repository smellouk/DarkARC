...
def main():
	...
	for response in range(1,5):
		print(response,atomic_response_function(response,element,n,l,kPrime,q),electronic_ionization_response_alternative(response,element,n,l,kPrime,q1,q2,q3))
...
def electronic_ionization_response_alternative(response,element,n,l,kPrime,q1,q2,q3):
	Wion = 0
	for m  in range(-l,l+1):
		for lPrime in range(lPrime_max+1):
			for mPrime in range(-lPrime,lPrime+1):
